...
// 💡 [핵심] TypeScript에게 외부 라이브러리(kakao)의 존재를 알리는 설정
declare global {
  interface Window {
    kakao: any;
    initMarkers: any;
      ...
      {isLogin && (
        <div style={{ width: '100%', height: '100vh', position: 'relative' }}>
          <div style={{ position: 'absolute', top: 0, left: 0, right: 0, zIndex: 10, backgroundColor: 'white', padding: '10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0 2px 5px rgba(0,0,0,0.1)' }}>
            ...
            <button onClick={() => setIsLogin(false)} style={{ padding: '5px 10px', backgroundColor: '#e74c3c', color: 'white', border: 'none', borderRadius: '5px' }}>로그아웃</button>
          </div>
